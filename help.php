...
.style20 {color: #CCFF00; font-weight: bold; }
#Layer6 {
	position:absolute;
	left:270px;
	top:478px;
...
<div id="maintop"></div>
	<div class="style4" id="right">
        <h4>Help or, Support </h4>
			<ul>
			  <li>What is JIBIKA.TK ?<br />
			  It is a vartual company.A man who want to be be a self independent it will help him to be a self independent person. <br class="style8" />
	            <br />
              </li>
        </ul>
			<p class="style8">&nbsp;</p>
